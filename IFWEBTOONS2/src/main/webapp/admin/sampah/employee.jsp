            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li>
                            <a  href="index.jsp">
                                <i class="" href="index.jsp"></i>home</a>
                        </li>
                        <li>
                               <a href="comicus.jsp"> 
                               <i class=""  href="comicus.jsp"></i>comicus tabel</a>
                        </li>
                        <li>
                            <a href="table.jsp">
                                <i class=""></i>data user</a>
                        </li>
                        <li>
                            <a href="form.jsp">
                                <i class=""></i>comic form</a>
                        </li>
                        <li>
                            <a href="form.jsp">
                                <i class=""></i>data contact us page</a>
                        </li>
                </div>
            </nav>
        </header>
...
<div class="form-group">
<input type="text" class="form-control form-control-user" id="sebagai" 
placeholder="as">
</div>
<div class="form-group">
...
<script src="vendor/jquery-easing/jquery.easing.min.js"></script>
             ...
             function save_user() {
            	 ...
            	 var foto = file.name;
            	 var uid = firebase.database().ref().child('email').push().key;
            	 var data = {
            	 name: name,
            	 sebagai: sebagai,
            	 email: email,
            	 ...
            	 var updates = {};
            	 updates['/empl2/' + uid] = data;
            	 firebase.database().ref().update(updates);
            	 alert('mahasiswa created successfully!');
            	 }
