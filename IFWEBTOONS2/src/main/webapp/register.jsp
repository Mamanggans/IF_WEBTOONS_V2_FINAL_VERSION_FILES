        ...
        <div class="container-login100" style="background-image: url('img/bg-01.jpg');background-size: cover;">
			<div class="wrap-login100">
					...
					<div class="wrap-input100 validate-input">
                        <input   type="text" id="full_name" class="input100" required>
					...
					<div class="wrap-input100 validate-input" >
                        <input  type="text" id="favourite_comic" class="input100" required>
                        <span class="focus-input100" data-placeholder="What is Your Favourite Comic ?"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "yes or no">
                        <input   type="text" id="from_indonesia" class="input100" required>
                        <span class="focus-input100" data-placeholder="come from indonesia? ( Yes | No )"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						...
						<button  onclick="register()" style="color: white;">REGISTER
					</button>
					</div>
					</div>
					</div>
