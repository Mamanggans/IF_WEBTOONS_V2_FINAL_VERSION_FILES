			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>About Us</h2>
						<p>this page is telling you about this IF Webtoons and about the web maker </p>
					</div>
				</div>
			</div>
		</div>
    ...
    <section class="team-member-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Our IF Webtoons Creator</h2>
                        <p>These are our programmer, you can see each person information</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <strong>name</strong>
                                                    <span>the name of our comicus and web maker</span>
                                                </th>
                                                <th>
                                                    <strong>as</strong>
                                                    <span>the work who they do</span>
                                                </th>
                                                <th>
                                                    <strong>Email</strong>
                                                ...
                                                <th>
                                                    <strong>Photo</strong>
                                                    <span>the photo of our handsome worker</span>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="cs-text">
                        <div class="ct-address">
                            <span>Address:</span>
                            <p>Jl. Nusa Indah IV Gg. 6, RT.7/RW.4, Malaka Jaya, Kota Jakarta Timur<br/>Daerah Khusus Ibukota Jakarta</p>
                        </div>
                        <ul>
                            <li>
                                <span>Phone:</span>
    ...
    <script>
        $.getJSON("data.json",function(data){
            ...
            $.each(data, function(key, val){
                items.push("<tr>");
                items.push("<td class='number' id='"+key+"'>"+val.id+"</td>");
                items.push("<td class='break hover-bg' id='"+key+"'><h5>"+val.nama+"</h5></td>");
                items.push("<td class='break hover-bg' id='"+key+"'><h5>"+val.as+"</h5></td>");
                items.push("<td class='break hover-bg' id='"+key+"'><h5>"+val.email+"<h5></td>");
                items.push("<td id='"+key+"' style='text-align:center'><img src='img/authors/"+val.foto+"' style='height:100px;width: 100px;'></td>");
                items.push("</tr>");
            });
