		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p>Fill out the form below to give us a feedback so we can improve our website.</p>
					<div class="row">
						<div class="col-md-9">
							<ul class="contact-info-list" style="margin-top: -70px;">
							</br>
								<li><div class="cf-left">Address</div><div class="cf-right">Kav.Cipayung, blok. M, no.4 , Kota Jakarta Timur
									Daerah Khusus Ibukota Jakarta </div></li>
								<li><div class="cf-left">Phone</div><div class="cf-right">+62 81-3850-10309</div></li>
