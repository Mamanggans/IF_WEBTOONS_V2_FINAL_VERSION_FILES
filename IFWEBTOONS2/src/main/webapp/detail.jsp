...
<html lang="en">
<head>
	<title id="title"><%out.println(rs.getString(2));%> || contact us </title>
	<meta charset="UTF-8">
...
<body ng-app="validationApp" ng-controller="mainController">
		...
		<div class="container">
			...
			<nav class="main-menu">
				<ul>
					...
					<li><a href="#">Comic</a>
                            <ul class="dropdown" style="margin-left: 30%">
	...
	<!-- Page info section -->
 <h2 class="judul" id="profile" >Judul Comic</h2>
    <main>
    <div id="content">
      
      <article id="about" class="card">
         <h2 class="judul-sub"style="">Deskripsion</h2>
         <img src="img/comic/boruto.jpg" class="abt-img" alt="sejarah"></img>
     ...
     <aside>
      <article class="profile card">
         <section>
          ...
          <div class="nama-kel">
            <figure>
              <img class="authors" src="getImageDetails.jsp?your_id=<%out.println(rs.getInt(1));%>" onerror="this.onerror=null; this.src='img/cover.jpg'">
             </figure>
    ...
    <div class="lesson-wrapper">
      <div class="container_comic">
        <div class="heading">
           <h2 class="judul_comic">Chapter Judul Comic</h2>
           <p class="tengah-txt">front-end devloper</p>
        </div>
        <div class="container-chapters-comic">
          <a class="box-chapter">Chapter 1 Forza Horizon Phoenix </a>
          <a class="box-chapter">Chapter 1 Forza Horizon Phoenix</a>
          <a class="box-chapter">Chapter 1 Forza Horizon Phoenix</a>
          <a class="box-chapter">Chapter 1 Forza Horizon Phoenix</a>
       </div>  
